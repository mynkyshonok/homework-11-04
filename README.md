...
Начиная с 4-ой версии rabbitmq убрали политики HA, вместо этого теперь используется тип очередей quorum. Для работы с quorum требуется не менее 3 нод
...
![dis_rmq01](zad3_5.png)

#### Consumer принял сообщение со второй ноды:
